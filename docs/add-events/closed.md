...
Use the date when the location will first be closed. If renovation begin on a Monday, but the library is normally closed Sunday. Use Sunday as the start date for the closure event.
