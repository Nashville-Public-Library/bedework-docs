...
Use for events that repeat in an orderly pattern, such as “Every 1st Thursday” or “Every Saturday”.
   ...
   1. Under Repeat, select an end date _one day past_ the end of the next quarter. For a program occurring every Thursday, through May 26, enter the end date as the Jun.
   1. Do not keep _forever_ selected.
...
1. Select the start time for your event. This selector uses a 24-hour clock).
...
1. After saving her event, Sue will click on the `Approval Queue` tab and find the December 15th instance of her event and click on the title of the event.
