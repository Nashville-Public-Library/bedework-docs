...
When do we mark an event canceled vs just updating the existing event listing with new info?
...
- Canceled: If the event is totally canceled and isn’t just moving online, mark the event canceled or delete.
